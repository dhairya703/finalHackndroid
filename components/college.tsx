  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="absolute top-0 flex h-full w-full flex-col items-center justify-center gap-1 text-center font-secondary tracking-wider sm:gap-5 xl:-mt-4">
        <span className="text-xl lowercase  text-primary md:-mt-2 md:text-2xl xl:-mt-4 lg:text-3xl">
          hackathon venue
        </span>
        <span className="text-2xl lowercase text-white md:text-3xl xl:-mt-2 lg:text-4xl">
          christ college of engineering
        </span>
        <span className="xs:pt-2 font-tertiary text-lg font-semibold tracking-normal text-tertiary md:-mt-2 xl:-mt-6 lg:text-xl">
