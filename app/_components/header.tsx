...
const Header = ({ type = "primary" }: HeaderProps) => {
  return type === "primary" ? (
    ...
    <div className="text-stroke-white flex h-24 justify-center overflow-clip border-b border-quarternary font-primary text-[304px] leading-none text-transparent">
